...
- Deployed as a static export (`output: "export"`) to Cloudflare Pages from the GitHub repo (`wrangler.jsonc` points Pages at `out/`). No server runtime: everything, including the Open Graph card, is generated at build time.
